...
import org.fxmisc.undo.DirectedAcyclicGraph;
...
public class DefaultDirectedAcyclicGraph<C> implements DirectedAcyclicGraph<C> {
     ...
     */
    public DefaultDirectedAcyclicGraph(
